...
def display_pas():
    """ prints PAS Capital """
    print(generate_ascii_art('"Studying"', font='starwars', color='yellow', frame='red'))


warning_label = color_str('[*]', 'yellow')
deletion_label = color_str('[-]', 'red')
creation_label = color_str('[+]', 'green')


if __name__ == '__main__':
    from sys import argv
    print(generate_ascii_art(argv[1], font='starwars', color='yellow', frame='red'))
